...
cd "$(dirname "$0")/../../infrastructure/testing"
...
main_setup() {
    ...
    echo "   ${CYAN}cd infrastructure/testing && ./scripts/system-monitor.sh dashboard${NC}"
    echo ""
    echo -e "${YELLOW}📚 Documentation:${NC}"
    echo "   - Master Guide: infrastructure/testing/docs/README-DOCKER-TESTING.md"
    echo "   - Usage Guide: infrastructure/testing/docs/README-USAGE.md"
    echo "   - Troubleshooting: infrastructure/testing/docs/README-TROUBLESHOOTING.md"
}
