"""
Confirmation dialog renderer for the CrackSeg application.

This module handles the rendering, styling, and HTML generation for\
confirmation dialogs. Separated from core logic to maintain file size limits
and single
responsibility.
"""
...
from scripts.gui.utils.performance_optimizer import inject_css_once
...
class OptimizedConfirmationDialog:
    ...
    .crackseg-confirmation-header {
        display: flex;
        align-items: center;
        margin-bottom: 1.5rem;
    }

    .crackseg-confirmation-icon {
        width: 48px;
        height: 48px;
        border-radius: 50%;
        display: flex;
    ...
    .crackseg-confirmation-icon.low {
        background: #e3f2fd;
        color: #1976d2;
    }

    .crackseg-confirmation-icon.medium {
        background: #fff3e0;
        color: #f57c00;
    }

    .crackseg-confirmation-icon.high {
        background: #ffebee;
        color: #d32f2f;
    }

    .crackseg-confirmation-title {
        font-size: 1.25rem;
        font-weight: 600;
        color: #2c3e50;
        margin: 0;
    ...
    .crackseg-confirmation-input {
        margin-bottom: 1rem;
    }

    .crackseg-confirmation-input label {
        display: block;
        font-size: 0.9rem;
        color: #2c3e50;
    ...
    .crackseg-confirmation-input input {
        width: 100%;
        padding: 0.75rem;
    ...
    .crackseg-confirmation-input input:focus {
        outline: none;
        border-color: #3498db;
    }

    .crackseg-confirmation-input input.error {
        border-color: #e74c3c;
    }

    .crackseg-confirmation-buttons {
        display: flex;
        gap: 1rem;
    ...
    .crackseg-confirmation-button.cancel {
        background: #f8f9fa;
        color: #6c757d;
        border: 2px solid #e9ecef;
    }

    .crackseg-confirmation-button.cancel:hover {
        background: #e9ecef;
        color: #495057;
    }

    .crackseg-confirmation-button.confirm {
        background: #3498db;
        color: white;
    }

    .crackseg-confirmation-button.confirm:hover {
        background: #2980b9;
    }

    .crackseg-confirmation-button.confirm.medium {
        background: #f39c12;
    }

    .crackseg-confirmation-button.confirm.medium:hover {
        background: #e67e22;
    }

    .crackseg-confirmation-button.confirm.high {
        background: #e74c3c;
    }

    .crackseg-confirmation-button.confirm.high:hover {
        background: #c0392b;
    }

    .crackseg-confirmation-button:disabled {
        opacity: 0.6;
        cursor: not-allowed;
    }
