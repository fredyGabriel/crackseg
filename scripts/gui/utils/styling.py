...
This module provides functions for loading and applying custom CSS styles
...
def load_custom_css() -> None:
    """
    Finds and injects the custom CSS stylesheet into the Streamlit app.
    It constructs a path to 'main.css' relative to this file's location.
    """
