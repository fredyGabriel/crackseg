"""Pydantic models for report structure validation.

This module defines the data models for the JSON report generated by the
results gallery. Using Pydantic ensures that the report structure is
consistent and that the data types are correct.
"""
...
def create_report_data_model(
    ...
    """
    Validates a report dictionary and creates a Pydantic model.

    Args:
        report_dict: The dictionary to validate.

    Returns:
        A tuple containing the validated ReportData model (or None) and
