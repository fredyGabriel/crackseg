...
class CaptureStorageMixin:
    """Mixin to add capture storage capabilities to test classes."""

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        """Initialize storage mixin."""
        storage_config = kwargs.pop("storage_config", None)
    ...
    def store_artifact(
        ...
        """Store an artifact with proper naming and organization."""
        return self._capture_storage.store_artifact(
            file_path, artifact_type, test_name, metadata
        )

    def cleanup_test_artifacts(
        self, test_name: str, force: bool = False
    ) -> int:
        """Clean up artifacts for current test."""
        return self._capture_storage.cleanup_artifacts(test_name, force)

    def get_artifact_info(self, test_name: str) -> dict[str, Any]:
        """Get artifact information for test."""
        return self._capture_storage.get_artifact_info(test_name)
