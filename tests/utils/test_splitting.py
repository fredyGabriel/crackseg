...
from src.data.splitting import (split_indices, get_all_samples,  # noqa: E402
...
def test_split_indices_different_without_seed():
    ...
    assert splits1['train'] != splits2['train'] or \
           splits1['val'] != splits2['val'] or \
           splits1['test'] != splits2['test']
...
def test_split_indices_invalid_ratio_sum_infer():
    ...
    with pytest.raises(ValueError,
                       match="Sum of provided ratios cannot exceed 1.0"):
        split_indices(num_samples, ratios)
