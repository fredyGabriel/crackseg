"""
Concurrent operation tests module. Refactored from oversized
test_concurrent_operations.py to comply with 300-line limit. Contains
comprehensive concurrent operation testing across multiple focused
test files.
"""
