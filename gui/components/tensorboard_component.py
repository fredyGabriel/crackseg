"""TensorBoard component for CrackSeg GUI - Compatibility Layer.

This file provides backward compatibility by importing from the new modular
tensorboard component structure. All functionality has been refactored into
...
Legacy imports will continue to work:
    from scripts.gui.components.tensorboard_component import
