"""
Setup guide section for the results page.

This module handles the setup guide displayed when users haven't
completed the necessary prerequisites for viewing results.
"""
...
def render_setup_guide() -> None:
    ...
    with col2:
        ...
        - **[Training Page](/training)** - Start model training
        - **[Configuration](/config)** - Set up directories
