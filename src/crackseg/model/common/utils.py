"""Utility functions for U-Net model components.

This module provides utility functions for parameter counting, memory
estimation, layer hierarchy extraction, and configuration printing for U-Net
models.

For spatial calculations, see spatial_utils module.
For architecture visualization, see visualization module.
"""
